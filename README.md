...
|팀원|역할| 
|:---:|:---|
|팀장 윤현준|- 프로젝트 팀장 <br> - 프로젝트 관리 <br>- 지문자 인식 Server 연동 <br>- 한글 키보드 알고리즘 구현 <br>- 자동생성기 및 STT,TTS,지문자 출력 및 속도 조절 기능 개발 <br>- DataSet 수집|
|김동규|- 파이썬 소켓 통신 기반 통신 시스템 구현<br> - PyQt6 기반 서버 및 각종 클라이언트 GUI 개발 <br>- 클라이언트 접속 이력 DB 관리 <br> - 프로젝트 산출물 정리 총괄|
|송용탁|- 파이썬 소켓 통신 기반 통신 시스템 구현<br> - PyQt6 기반 서버 및 각종 클라이언트 GUI 개발 <br>- 통신부 코드 최적화 <br> - 프로젝트 산출물 정리|
|유윤하| - 비동기 프로세스 처리<br> - Thread 관리<br> - 지문자 인식, Server 연동 PM <br> - 수어인식 모델(LSTM) 학습<br> - Data 전처리  <br>|
