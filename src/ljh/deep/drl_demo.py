...
class CameraThread(QThread):
    ...
    def __init__(self, main_app):
        ...
        # 저장된 모델 파일 경로         
        model_path = '/home/rds/Desktop/git_ws/deeplearning-repo-5/src/yhj/result/handModelDemo.h5'
    ...
    def run(self):
        ...
        self.model = load_model('/home/rds/Desktop/git_ws/deeplearning-repo-5/src/yhj/result/handModelDemo.h5')  # 모델 경로 설정
            ...
            with self.mp_pose.Pose(
                ...
                while cap.isOpened():
                    ...
                    if results.multi_hand_landmarks:
                        ...
                        # QImage로 변환
                    qt_img = self.main_app.convert_cv_qt(image)  # MyApp 클래스의 메서드 호출
...
class MyApp(QDialog):
    def __init__(self):
        ...
        uic.loadUi('/home/rds/Desktop/git_ws/deeplearning-repo-5/src/yhj/result/drl_demo.ui', self)  # .ui 파일 경로를 여기에 적어주세요
    ...
    def add_word(self, input_word):
        if input_word.strip():  # 입력된 단어가 공백이 아닌지 확인
            word_df = pd.read_csv('/home/rds/Desktop/git_ws/deeplearning-repo-5/src/yhj/result/autocorrect.csv')  # 여기서 CSV 파일 경로 수정
            ...
            word_df.to_csv('/home/rds/Desktop/git_ws/deeplearning-repo-5/src/yhj/result/autocorrect.csv', index=False)
    ...
    def on_text_changed(self):
        self.word_df=pd.read_csv('/home/rds/Desktop/git_ws/deeplearning-repo-5/src/yhj/result/autocorrect.csv')
